...
public class DialogProvider implements IDialogProvider {
    ...
    private final IDialogChoice<CopyType> chooseCopyDialog;
    ...
    public DialogProvider(IApplicationState applicationState) {
        ...
        chooseCopyDialog = new ChooseCopyDialog(this.applicationState);
    }
    ...
    @Override
    public IDialogChoice<CopyType> getCopyTypeDialog() {
        return chooseCopyDialog;
    }
}
